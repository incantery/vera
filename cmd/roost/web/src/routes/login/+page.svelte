<script>
	...
	async function submit(e) {
		...
		else error = 'roost is not answering — is the binary still running?';
	}
</script>
...
>
	...
	>
		<div style="display: flex; align-items: baseline; gap: 8px;">
			<span style="font-family: var(--font-heading); font-weight: 600; font-size: 16px;">roost</span>
			<span
		...
		<div style="font-size: 12px; color: var(--color-neutral-500); line-height: 1.5;">
			this roost serves beyond the machine — enter the key it printed at startup
		</div>
